...
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Sanjuextractor_bot")
BOT_TEXT = "SANJU BHAI KA EXTRACTOR"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "1270406309"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003151373740)

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1003151373740) 
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "1-1003151373740"))
# -----------------------------------------------
